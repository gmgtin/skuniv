			...
			<div class="content">
				...
				<div class="main-content">
					...
					<div class="bottom-30px">
						<a href="#" class="btn btn-primary"><i class="fa fa-plus-square"></i> Create New Project</a>
						...
						<table class="table colored-header datatable project-list">
							...
							<tbody>
								<tr>
									...
									<td><img src="img2/user2.png" alt="Avatar" class="avatar img-circle" /> <a href="#">Michael</a></td>
								...
								<tr>
									...
									<td><img src="img2/user1.png" alt="Avatar" class="avatar img-circle" /> <a href="#">Antonius</a></td>
								...
								<tr>
									...
									<td><span class="label label-success">LOW</span></td>
									<td><img src="img2/user5.png" alt="Avatar" class="avatar img-circle" /> <a href="#">Jason</a></td>
									<td><span class="label label-warning">PENDING</span></td>
								</tr>
							</tbody>
						</table>
