            ...
            <div class="row">
                ...
                <div class="col-md-6">
                   <h4> Login with facebook <strong> / </strong>Google :</h4>
                    ...
                    <hr />
                     <h4> Or Login with <strong>Winder Account  :</strong></h4>
                    <br />
                     ...
                     <label>Enter ID : </label>
                        ...
                        <button type="submit" class="btn btn-info"><span class="glyphicon glyphicon-user"> login </span></button>
                        <hr />
                        
                      <a href="signup" class="btn btn-info"><span class="glyphicon glyphicon-user"></span> &nbsp;Sign Me up</a>&nbsp;
                        </form>
